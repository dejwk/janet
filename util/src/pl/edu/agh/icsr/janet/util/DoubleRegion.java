...
/**
 * Represents a contiguous region in an array of doubles. The region may be
 ...
 */
public final class DoubleRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final DoubleRegion EMPTY =
        new DoubleRegion(new double[0]);
     ...
     */
    public DoubleRegion(double[] array) {
     ...
     */
    public DoubleRegion(double[] array, int offset) {
     ...
     */
    public DoubleRegion(double[] array, int offset, int length) {
        if (array == null) {
