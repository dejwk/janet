...
/**
 * Represents a contiguous region in an array of bytes. The region may be
 ...
 */
public final class ByteRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final ByteRegion EMPTY =
        new ByteRegion(new byte[0]);
     ...
     */
    public ByteRegion(byte[] array, int offset) {
     ...
     */
    public ByteRegion(byte[] array, int offset, int length) {
        if (array == null) {
