...
/**
 * Mutable wrapper for boolean value. Since it is mutable, it may be used
 * for passing boolean values by reference (unlike java.lang.Boolean).
 */
public class BooleanWrapper {

    /**
     * wrapped, mutable boolean value.
     */
    public boolean val;

    /**
     * Constructs a new wrapper with a false value.
     */
