...
/**
 * Mutable wrapper for char value. Since it is mutable, it may be used
 * for passing char values by reference (unlike java.lang.Character).
 */
public class CharWrapper {

    /**
     * wrapped, mutable char value.
     */
    public char val;
