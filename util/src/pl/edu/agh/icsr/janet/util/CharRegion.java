...
/**
 * Represents a contiguous region in an array of chars. The region may be
 ...
 */
public final class CharRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final CharRegion EMPTY =
        new CharRegion(new char[0]);
     ...
     */
    public CharRegion(char[] array, int offset) {
     ...
     */
    public CharRegion(char[] array, int offset, int length) {
        if (array == null) {
