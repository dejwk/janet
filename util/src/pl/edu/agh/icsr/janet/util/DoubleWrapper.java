...
/**
 * Mutable wrapper for double value. Since it is mutable, it may be used
 * for passing double values by reference (unlike java.lang.Double).
 */
public class DoubleWrapper {

    /**
     * wrapped, mutable double value.
     */
    public double val;
