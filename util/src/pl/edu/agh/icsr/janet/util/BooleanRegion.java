...
/**
 * Represents a contiguous region in an array of booleans. The region may be
 ...
 */
public final class BooleanRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final BooleanRegion EMPTY =
        new BooleanRegion(new boolean[0]);
     ...
     */
    public BooleanRegion(boolean[] array) {
     ...
     */
    public BooleanRegion(boolean[] array, int offset) {
     ...
     */
    public BooleanRegion(boolean[] array, int offset, int length) {
        if (array == null) {
