...
/**
 * Represents a contiguous region in an array of longs. The region may be
 ...
 */
public final class LongRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final LongRegion EMPTY =
        new LongRegion(new long[0]);
     ...
     */
    public LongRegion(long[] array, int offset) {
     ...
     */
    public LongRegion(long[] array, int offset, int length) {
        if (array == null) {
