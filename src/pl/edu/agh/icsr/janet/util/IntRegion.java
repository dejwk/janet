...
/**
 * Represents a contiguous region in an array of ints. The region may be
 ...
 */
public final class IntRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final IntRegion EMPTY =
        new IntRegion(new int[0]);
     ...
     */
    public IntRegion(int[] array, int offset) {
     ...
     */
    public IntRegion(int[] array, int offset, int length) {
        if (array == null) {
