...
/**
 * Represents a contiguous region in an array of shorts. The region may be
 ...
 */
public final class ShortRegion implements Region {

    /**
     * The constant representing an empty region.
     */
    public static final ShortRegion EMPTY =
        new ShortRegion(new short[0]);
     ...
     */
    public ShortRegion(short[] array) {
     ...
     */
    public ShortRegion(short[] array, int offset) {
     ...
     */
    public ShortRegion(short[] array, int offset, int length) {
        if (array == null) {
